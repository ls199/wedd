...
namespace ContosoUniversity.Common
{
    ...
    {
        static string appkey = "2aa35fe990ef0a02706f62afeb45ef0a";//配置您申请的appkey

        public static Weather GetWeatherByCityName(string city)//JsonObject
        {
        ...
        public static Weather ConverToWearther(JsonObject jsonObj)
        {
            ...
            wt.Temperature = jsonObj["result"].Object["today"].Object["date_y"].Value;
            wt.Humidity = jsonObj["result"].Object["sk"].Object["Wind_strength"].Value;
            return wt;
        }
        /// <summary>
        /// Http (GET/POST)
